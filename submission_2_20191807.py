...
def submission_2_20191807(yaml_path, output_json_path):
    ...
    momentum = 0.9
    weight_decay = 1e-4
    ex_dict['augment'] = True
    ex_dict['hsv_h'] = 0.015   # 색조 변화 (Hue)
    ex_dict['hsv_s'] = 0.7     # 채도 변화 (Saturation)
